...
//    float h = sin(sqrt(pow(coords.x, 2) + pow(coords.y, 2)) - timestep * 0.0001);
    ...
    float c = rgb.r;
//    float c = rgb.r < 0.5 ? 0 : 1;
//    fragColor = vec4(c, c, c, 1);
//    fragColor = vec4(c, 0, 0, 1);
//    fragColor = vec4(rgb.r < 0.5 ? 0 : 1, rgb.g < 0.5 ? 0 : 1, rgb.b < 0.5 ? 0 : 1, 1);
//    fragColor = vec4(0, rgb.g, 0, 1);
//    fragColor = vec4(0, 0, rgb.b, 1);
//    fragColor = vec4(rgb.r - rgb.g, rgb.b - rgb.g, rgb.b, 1);
